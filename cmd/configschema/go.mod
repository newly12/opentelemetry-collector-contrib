...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/processor/servicegraphprocessor v0.62.0 // indirect
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.520 // indirect
