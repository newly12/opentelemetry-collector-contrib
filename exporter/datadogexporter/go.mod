...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.38.0-rc.6
	github.com/DataDog/datadog-agent/pkg/quantile v0.38.0-rc.6
	github.com/DataDog/datadog-agent/pkg/trace v0.38.0-rc.6
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.38.0-rc.6 // indirect
