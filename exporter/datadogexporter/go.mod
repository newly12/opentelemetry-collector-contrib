...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.38.0
	github.com/DataDog/datadog-agent/pkg/quantile v0.38.0
	github.com/DataDog/datadog-agent/pkg/trace v0.38.0
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.38.0 // indirect
