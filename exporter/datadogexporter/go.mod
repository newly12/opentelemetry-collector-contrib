...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.43.0
	github.com/DataDog/datadog-agent/pkg/quantile v0.43.0
	github.com/DataDog/datadog-agent/pkg/trace v0.43.0
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/util/cgroups v0.43.0 // indirect
	github.com/DataDog/datadog-agent/pkg/util/log v0.43.0 // indirect
	github.com/DataDog/datadog-agent/pkg/util/pointer v0.43.0 // indirect
	github.com/DataDog/datadog-agent/pkg/util/scrubber v0.43.0 // indirect
