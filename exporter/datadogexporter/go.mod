...
require (
	...
	github.com/DataDog/datadog-agent/pkg/otlp/model v0.38.1-rc.1
	github.com/DataDog/datadog-agent/pkg/quantile v0.38.1-rc.1
	github.com/DataDog/datadog-agent/pkg/trace v0.38.1-rc.1
...
require (
	...
	github.com/DataDog/datadog-agent/pkg/obfuscate v0.38.1-rc.1 // indirect
	github.com/DataDog/datadog-agent/pkg/remoteconfig/state v0.38.1-rc.1 // indirect
